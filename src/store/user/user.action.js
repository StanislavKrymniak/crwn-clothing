...
export const googleSignInStart = () => createAction(USER_ACTION_TYPES.EMAIL_SIGN_IN_START)
...
export const signUpSucces = (user, additionalDetails) => createAction(USER_ACTION_TYPES.SIGN_UP_SUCCES, {user, additionalDetails})
